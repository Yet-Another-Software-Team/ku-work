    ...
    <section class="w-full">
        ...
        <section>
            ...
            <section class="h-[3em] overflow-hidden border-b-1 my-5">
                <div class="flex flex-row gap-2 h-[6em] w-[40em] left-0 top-0">
                    <div
...
function setTailwindClasses(activeCondition: string) {
    ...
    if (condition == activeCondition) {
        if (condition == "inprogress") {
            return "bg-yellow-200 flex flex-col border-1 rounded-3xl w-1/2 text-yellow-800 hover:bg-yellow-300";
        } else if (condition == "accepted") {
            return "bg-green-200 flex flex-col border-1 rounded-3xl w-1/2 text-primary-800 hover:bg-primary-300";
        }
        return "bg-error-200 flex flex-col border-1 rounded-3xl w-1/2 text-error-800 hover:bg-error-300";
    } else {
