<template>
  ...
  >
    <!-- Modal -->
    <div
      class="w-[380px] rounded-2xl p-6 shadow-lg bg-white text-gray-900 dark:text-white"
    >
      ...
      <div v-if="currentStep === 1">
        ...
        >
          ...
          <div class="mx-auto grid place-items-center gap-2">
            <div
              class="h-10 w-10 rounded-full bg-neutral-400 grid place-items-center"
            >
              <Icon
                name="basil:file-upload-outline"
        ...
        <span
          v-if="errors.resumeFile"
          class="text-error text-sm mt-1 block"
          >{{ errors.resumeFile }}</span
        >
        ...
        <div class="mt-4 grid grid-cols-2 gap-4">
          <div>
            ...
            />
            <span
              v-if="errors.contactPhone"
              class="text-error text-sm"
              >{{ errors.contactPhone }}</span
            >
          </div>
          <div>
            <div class="text-[13px] text-primary-800 font-semibold mb-1">
            ...
            />
            <span
              v-if="errors.contactMail"
              class="text-error text-sm"
              >{{ errors.contactMail }}</span
            >
          </div>
        </div>
...
function openForm() { open.value = true }
function closeForm() {
    open.value = false
}
