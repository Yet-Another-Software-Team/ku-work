<template>
    <div class="rounded-lg">
        <!-- Header -->
        <a :href="`/dashboard/${route.params.id}`">
            <h1
        ...
        <section class="flex flex-col sm:flex-row">
            ...
            <section class="w-full sm:w-[20em] flex flex-col gap-5 m-3">
                ...
                <div class="r-card">
                    <div
                        v-for="file in data.profile.files"
                        :key="file.name"
            ...
            <section class="flex flex-col gap-5 m-3 w-full">
                ...
                <div class="r-card">
                    <div class="flex flex-col text-xl text-left whitespace-normal">
                        ...
                        <p class="text-gray-800 dark:text-gray-200 font-semibold">
                            Email: <span class="font-normal">{{ data.profile.email }}</span>
                        </p>
                    </div>
                </div>
...
// Compute age
const age = computed(() => {
    const birth = new Date(props.data?.profile?.birthDate ?? "");
...
function acceptRequest() {
    console.log("Accepted request:", props.data.profile.id);
    toast.add({
...
function declineRequest() {
    console.log("Declined request:", props.data.profile.id);
    toast.add({
