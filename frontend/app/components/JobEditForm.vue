    ...
    <form class="space-y-4 w-full flex-1" @submit.prevent="onSubmit">
      ...
      <div class="grid grid-cols-12 gap-4 items-center w-full">
        ...
        <div class="col-span-12 md:col-span-8">
          <UInput v-model="form.title" placeholder="Enter job title" class="w-full bg-white" />
      ...
      <div class="grid grid-cols-12 gap-4 items-center w-full">
        ...
        <div class="col-span-12 md:col-span-8">
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <UInput v-model="form.minSalary" type="number" placeholder="Minimum Salary" class="w-full">
              <template #trailing>Baht</template>
            </UInput>
            <UInput v-model="form.maxSalary" type="number" placeholder="Maximum Salary" class="w-full">
              <template #trailing>Baht</template>
            </UInput>
          </div>
      ...
      <div class="grid grid-cols-12 gap-4 items-start w-full">
        ...
        <div class="col-span-12 md:col-span-8">
          <UTextarea v-model="form.description" rows="6" placeholder="Enter job description" class="w-full" />
        ...
        <div class="col-span-12 md:col-start-9 md:col-span-4 flex justify-end gap-x-3">
          ...
          <template #body>
                ...
                <p class="text-gray-600">
                    This will discard your current inputs and reload your old data. Are you sure?
                </p>
                </div>
            </template>
                <template #footer>
